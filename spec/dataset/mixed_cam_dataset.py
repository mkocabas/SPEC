...
from pare.utils.train_utils import parse_datasets_ratios
...
class MixedCamDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, options, **kwargs):
        ...
        # }
        itw_datasets = ['mpii', 'lspet', 'coco', 'mannequin']
        occluders = None
        ...
        self.datasets = [CamDataset(options, ds, occluders=occluders, **kwargs)
